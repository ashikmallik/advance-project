            ...
            <div class="row gutters-10 position-relative">
               <!--Category menu -->
                ...
                <!--Category menu ends -->
                        ...
                        <!--margin-bottom:-277px-->
                 <div class="col-lg-3 position-static d-none d-lg-block" style="margin-bottom:-455px;margin-left:40px;z-index:2;">
                          @include('frontend.partials.category_menu2')
                  </div>
                    ...
                    <div class="col-xl col-md-12">
                        <div class="mb-3 mb-lg-0">
                            <a href="{{ json_decode(get_setting('home_banner2_links'), true)[$key] }}" class="d-block text-reset">
                                <img style="height:180px;" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset($banner_2_imags[$key]) }}" alt="{{ env('APP_NAME') }} promo" class="img-fluid lazyload w-100 ">
                            </a>
                        </div>
                    </div>
                @endforeach
                    ...
                    <div class="col-lg-12">
                        <div class="mb-3 mb-lg-0">
                            <!--<a href="{{ json_decode(get_setting('home_banner1_links'), true)[$key] }}" class="d-block text-reset">-->
                                <img src="{{asset('public/assets/shakib.jpg')}}"  alt="shakib" class="img-fluid lazyload w-100 rounded">
                            <!--</a>-->
                        </div>
                    </div>
