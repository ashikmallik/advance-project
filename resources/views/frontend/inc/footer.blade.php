...
<section class="py-5 text-light footer-widget" style="background-color:#2E2E54 !important;">
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    ...
                    <div class="w-300px mw-100 mx-auto mx-md-0">
                         <h6 class="" style="color:#0095F1!important; font-size:16px !important;">Happy Shopping</h6>
                          <h6 class="" style="color:white !important; font-size:16px !important;">Download App</h6>
    ...
    <div class="container">
        <div class="row">
                ...
                <div class="">
                   ...
                   <h6 class="" style="color:black !important; font-size:16px !important;">Payment Methods</h6>
             ...
             <div class="col-lg-4">
                  <h6 class="" style="color:black !important; font-size:16px !important;">Follow Us</h6>
            ...
            <div class="col-lg-4">
                <h6 class="" style="color:black !important; font-size:16px !important;">Verified by</h6>
                <ul class="list-inline">
                    <li class="list-inline-item">
                                 <img src="{{asset('public/assets/img/ecab.png') }}" height="30" class="mw-100 h-auto" style="max-height: 35px">
                                </li>
                </ul>
            </div>
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-12">
                 <div class="text-center text-md-left" style="color:black !important; font-size:16px !important;" current-verison="{{get_setting("current_version")}}">
    ...
    <div class="row align-items-center gutters-5">
        <div class="col">
            <a href="{{ route('home') }}" class="text-reset d-block text-center pb-2 pt-3">
                <i class="las la-house-damage fs-20 opacity-60 {{ areActiveRoutes(['home'],'opacity-100 text-primary')}}"></i>
        ...
        <div class="col">
            <a href="{{ route('categories.all') }}" class="text-reset d-block text-center pb-2 pt-3">
                <i class="las la-ellipsis-v fs-20 opacity-60 {{ areActiveRoutes(['categories.all'],'opacity-100 text-primary')}}"></i>
        ...
        <div class="col">
            <a href="{{ route('all-notifications') }}" class="text-reset d-block text-center pb-2 pt-3">
                <span class="d-inline-block position-relative px-2">
                    <i class="las la-bullhorn fs-20 opacity-60 {{ areActiveRoutes(['all-notifications'],'opacity-100 text-primary')}}"></i>
